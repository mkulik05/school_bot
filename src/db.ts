...
const logger = create_log("database")
...
let objs_are_simple = (obj1: object, obj2: object, tg_id: string, skip_keys = [ '_id' ]) => {
...
let update_db = async (url: string, data: Array<object>, tg_id: string, col_name = 'test') => {
